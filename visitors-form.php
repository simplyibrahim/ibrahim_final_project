...
<body class="animsition" onload="myFunction">
...
$sdata=$_POST['searchdata'];
  ?>
                                      ...
                                      <?php
$ret=mysqli_query($con,"SELECT `FullName` FROM `tblvisitor` WHERE `Student_num` LIKE '$sdata%' ");
...
?>
                ...
                ?>
                 <script>
function myFunction() {
  document.getElementById("myText").value = <?php echo $row['FullName']?>;
}
</script> 
    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="myText" name="fullname" placeholder="Full Name" class="form-control" required=""  >
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="email-input" class=" form-control-label">ID Number</label>
                                                    </div>
                                                <div class="col-12 col-md-9">
                                                    <input class="form-control" type="text" name="searchdata" id="searchdata" placeholder="ID Number or Student number">
